...
export class Migration1712872566767 implements MigrationInterface {
    name = 'Migration1712872566767'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "profile" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "nim" character varying NOT NULL, "name" character varying NOT NULL, "phone" character varying NOT NULL, "address" character varying NOT NULL, "school" character varying NOT NULL, "birthdate" TIMESTAMP NOT NULL, "class_id" integer NOT NULL, CONSTRAINT "REL_2b0a3ff1a1b98d455c0053b167" UNIQUE ("class_id"), CONSTRAINT "PK_3dd8bfc97e4a77c70971591bdcb" PRIMARY KEY ("id"))`);
