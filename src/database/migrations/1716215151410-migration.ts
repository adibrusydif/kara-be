...
export class Migration1716215151410 implements MigrationInterface {
    name = 'Migration1716215151410'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "attendance" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "profile_id" integer NOT NULL, "schedule_id" integer NOT NULL, "time" TIMESTAMP, "verify_by" character varying, CONSTRAINT "REL_a64a9ade5eb944dcb7dd4f4b5e" UNIQUE ("profile_id"), CONSTRAINT "PK_ee0ffe42c1f1a01e72b725c0cb2" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "schedule" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "start_time" TIMESTAMP, "end_time" TIMESTAMP, "class_id" integer NOT NULL, "subject_id" integer NOT NULL, "teacher_id" integer NOT NULL, "room" character varying NOT NULL, "info" character varying NOT NULL, CONSTRAINT "PK_1c05e42aec7371641193e180046" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "profile" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "nim" character varying, "name" character varying, "phone" character varying, "parent_phone" character varying, "parent_name" character varying, "gender" character varying, "height" character varying, "address" character varying, "image" character varying, "school" character varying, "birthdate" TIMESTAMP, "class_id" integer, CONSTRAINT "PK_3dd8bfc97e4a77c70971591bdcb" PRIMARY KEY ("id"))`);
